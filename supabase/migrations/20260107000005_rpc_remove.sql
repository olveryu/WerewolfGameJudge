CREATE OR REPLACE FUNCTION public.remove_field_key(p_room_number TEXT, p_field TEXT, p_key TEXT)
...
EXECUTE format('UPDATE public.rooms SET %I = COALESCE(%I, ''{}''::jsonb) - $1 WHERE room_number = $2', p_field, p_field) USING p_key, p_room_number;
