...
export function handleStartNight(state: WerewolfState, action: StartNightAction): WerewolfState {
...
export function handleEndNight(state: WerewolfState, action: EndNightAction): WerewolfState {
