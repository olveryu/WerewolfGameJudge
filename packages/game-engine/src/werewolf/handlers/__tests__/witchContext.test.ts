...
import { maybeCreateWitchContextAction } from '@werewolf/game-engine/werewolf/handlers/witchContext';
...
function createOngoingState(overrides: Partial<WerewolfState> = {}): NonNullable<WerewolfState> {
  return {
    roomCode: '1234',
    hostUserId: 'host-uid',
