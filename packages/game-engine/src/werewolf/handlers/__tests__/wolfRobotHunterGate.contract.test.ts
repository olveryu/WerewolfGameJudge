...
import { handleAdvanceNight } from '@werewolf/game-engine/werewolf/handlers/stepTransitionHandler';
...
function createTestState(overrides?: Partial<WerewolfState>): WerewolfState {
  return {
    roomCode: 'TEST',
    hostUserId: 'HOST',
