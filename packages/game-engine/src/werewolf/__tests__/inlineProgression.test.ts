 ...
 *
 * Test strategy:
 * - Build a WerewolfState with completed actions
...
const TEMPLATE_2P: WerewolfState['templateRoles'] = ['wolf', 'villager'];
const TEMPLATE_5P: WerewolfState['templateRoles'] = ['wolf', 'wolf', 'seer', 'witch', 'villager'];

function make2PlayerState(overrides: Partial<WerewolfState> = {}): WerewolfState {
...
function make5PlayerState(overrides: Partial<WerewolfState> = {}): WerewolfState {
