 ...
 *
 * Validates that all 41 roles have structuredDescription defined
 * and that structured content is semantically consistent with the flat description.
 */

import { getAllRoleIds, ROLE_SPECS } from '@werewolf/game-engine/werewolf/models/roles/spec';
...
import { getRoleStructuredDescription } from '@werewolf/game-engine/werewolf/models/roles/spec/specs';
