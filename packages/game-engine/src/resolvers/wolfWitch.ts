...
export const wolfWitchCheckResolver: ResolverFn = (context, input) => {
  ...
  // Validate constraints from schema (includes notWolfFaction — requires players map)
  const schema = SCHEMAS.wolfWitchCheck;
