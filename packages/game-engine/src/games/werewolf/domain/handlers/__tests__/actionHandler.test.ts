...
import {
  ...
  isSkipAction,
} from '@game-judge/game-engine/games/werewolf/domain/handlers/actionGuards';
...
import { handleViewedRole } from '@game-judge/game-engine/games/werewolf/domain/handlers/viewedRoleHandler';
import type {
  SubmitActionIntent,
  ViewedRoleIntent,
