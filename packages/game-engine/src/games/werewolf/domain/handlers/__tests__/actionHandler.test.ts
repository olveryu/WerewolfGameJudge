...
import {
  ...
  isSkipAction,
} from '@werewolf/game-engine/games/werewolf/domain/handlers/actionGuards';
...
import { handleViewedRole } from '@werewolf/game-engine/games/werewolf/domain/handlers/viewedRoleHandler';
import type {
  SubmitActionIntent,
  ViewedRoleIntent,
