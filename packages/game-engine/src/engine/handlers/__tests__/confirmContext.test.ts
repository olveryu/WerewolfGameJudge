...
function createOngoingState(overrides: Partial<GameState> = {}): NonNullable<GameState> {
  return {
    ...
    players: {
      ...
      5: { userId: 'p5', seatNumber: 5, hasViewedRole: true, role: 'witch' },
      6: { userId: 'p6', seatNumber: 6, hasViewedRole: true, role: 'hunter' },
    },
    currentStepIndex: 0,
...
describe('maybeCreateConfirmStatusAction', () => {
  ...
  it('狼王被毒 → canShoot = false', () => {
    const state = createOngoingState({
      ...
      players: {
        0: { userId: 'p0', seatNumber: 0, hasViewedRole: true, role: 'wolf' },
        1: { userId: 'p1', seatNumber: 1, hasViewedRole: true, role: 'darkWolfKing' },
        2: { userId: 'p2', seatNumber: 2, hasViewedRole: true, role: 'villager' },
        3: { userId: 'p3', seatNumber: 3, hasViewedRole: true, role: 'villager' },
        4: { userId: 'p4', seatNumber: 4, hasViewedRole: true, role: 'seer' },
        5: { userId: 'p5', seatNumber: 5, hasViewedRole: true, role: 'witch' },
  ...
  it('摄梦人摄猎人 + 摄梦人被狼刀 → canShoot = false', () => {
    const state = createOngoingState({
      ...
      players: {
        ...
        5: { userId: 'p5', seatNumber: 5, hasViewedRole: true, role: 'witch' },
        6: { userId: 'p6', seatNumber: 6, hasViewedRole: true, role: 'hunter' },
        7: { userId: 'p7', seatNumber: 7, hasViewedRole: true, role: 'dreamcatcher' },
      },
  ...
  it('狼美人魅惑猎人 + 狼美人被毒杀 → canShoot = false', () => {
    const state = createOngoingState({
      ...
      players: {
        0: { userId: 'p0', seatNumber: 0, hasViewedRole: true, role: 'wolf' },
        1: { userId: 'p1', seatNumber: 1, hasViewedRole: true, role: 'wolfQueen' },
        2: { userId: 'p2', seatNumber: 2, hasViewedRole: true, role: 'villager' },
        3: { userId: 'p3', seatNumber: 3, hasViewedRole: true, role: 'villager' },
        4: { userId: 'p4', seatNumber: 4, hasViewedRole: true, role: 'seer' },
        5: { userId: 'p5', seatNumber: 5, hasViewedRole: true, role: 'witch' },
  ...
  it('影子模仿好人 → 复仇者为狼人阵营 (faction = wolf)', () => {
    const state = createOngoingState({
      ...
      players: {
        0: { userId: 'p0', seatNumber: 0, hasViewedRole: true, role: 'wolf' },
        1: { userId: 'p1', seatNumber: 1, hasViewedRole: true, role: 'wolf' },
        2: { userId: 'p2', seatNumber: 2, hasViewedRole: true, role: 'wolf' },
        3: { userId: 'p3', seatNumber: 3, hasViewedRole: true, role: 'villager' },
        4: { userId: 'p4', seatNumber: 4, hasViewedRole: true, role: 'villager' },
        5: { userId: 'p5', seatNumber: 5, hasViewedRole: true, role: 'villager' },
        6: { userId: 'p6', seatNumber: 6, hasViewedRole: true, role: 'seer' },
        7: { userId: 'p7', seatNumber: 7, hasViewedRole: true, role: 'witch' },
        8: { userId: 'p8', seatNumber: 8, hasViewedRole: true, role: 'guard' },
        9: { userId: 'p9', seatNumber: 9, hasViewedRole: true, role: 'shadow' },
        10: { userId: 'p10', seatNumber: 10, hasViewedRole: true, role: 'avenger' },
      },
