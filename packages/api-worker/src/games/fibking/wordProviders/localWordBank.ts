...
const LOCAL_FIB_WORD_SEEDS = [
  ...
  { word: '电子榨菜', definition: '吃饭时用来佐餐的轻松视频或其他内容。' },
  { word: '情绪价值', definition: '一段关系带给人的积极情绪体验和支持。' },
  { word: '信息茧房', definition: '因持续接触同类信息而形成的封闭认知空间。' },
  { word: '数字游民', definition: '依靠网络远程工作并在不同地点生活的人。' },
  { word: '反向旅游', definition: '刻意避开热门地点或高峰时段的旅行方式。' },
  { word: '松弛感', definition: '面对压力时仍显得自然从容的状态。' },
  { word: '钝感力', definition: '不因外界刺激或评价而过度反应的能力。' },
  { word: '显眼包', definition: '言行格外醒目且常带喜剧效果的人。' },
  { word: '班味', definition: '长期上班后显出的疲惫拘谨气质。' },
  { word: '社交电量', definition: '用来比喻一个人进行社交活动的精力储备。' },
  { word: '赛博搭子', definition: '主要在线上陪伴交流的轻量伙伴。' },
  { word: '搭子文化', definition: '围绕特定活动结成轻量伙伴关系的社交方式。' },
  { word: '精神离职', definition: '仍在岗位上但心理上已降低投入与认同的状态。' },
  { word: '已读乱回', definition: '看过消息后故意给出跳脱或不相干的回复。' },
  ...
  { word: '沉没成本', definition: '已经付出且无法收回，不应左右后续决策的成本。' },
  { word: '多巴胺穿搭', definition: '用明亮高饱和色彩营造愉悦感的穿衣风格。' },
