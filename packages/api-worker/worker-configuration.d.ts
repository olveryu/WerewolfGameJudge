/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --config wrangler.toml --env-interface WorkerBindings --strict-vars=false` (hash: 126869a1dada1a725bff2e38b5e3b657)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_WORKER_SCRIPT_NAME" | "SENTRY_DSN" | "ADMIN_PASSWORD" | "CF_API_TOKEN" | "GEMINI_API_KEY" | "GITHUB_REPO_OWNER" | "GITHUB_TOKEN" | "GITHUB_WEBHOOK_SECRET" | "JWT_SECRET" | "RESEND_API_KEY" | "WECHAT_APP_ID" | "WECHAT_APP_SECRET">> {}
}
