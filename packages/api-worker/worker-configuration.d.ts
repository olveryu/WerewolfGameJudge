/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --config wrangler.toml --env-interface WorkerBindings --strict-vars=false` (hash: 56277d9305820642b85c452f1f905d87)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "FIB_WORD_PROVIDER" | "CLOUDFLARE_ACCOUNT_ID" | "SENTRY_DSN" | "ADMIN_PASSWORD" | "CF_API_TOKEN" | "GEMINI_API_KEY" | "GITHUB_REPO_OWNER" | "GITHUB_TOKEN" | "GITHUB_WEBHOOK_SECRET" | "JWT_SECRET" | "RESEND_API_KEY" | "WECHAT_APP_ID" | "WECHAT_APP_SECRET">> {}
}
