/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --config wrangler.toml --env-interface WorkerBindings --strict-vars=false` (hash: 0d7fea7058a020d0c889d2860c5f4d8b)
