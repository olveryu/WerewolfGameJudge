/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ed618951e8a74e676933ffc6774519e0)
...
declare namespace Cloudflare {
  ...
  interface Env {
    ...
    SENTRY_DSN:
      | ''
      | 'https://ab73f1bb71521dace0123c021e0130e9@o4510871644209152.ingest.us.sentry.io/4511310645035008';
    JWT_SECRET: string;
    AVATARS?: R2Bucket;
    DB?: D1Database;
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, 'ENVIRONMENT' | 'CORS_ORIGIN' | 'SENTRY_DSN' | 'JWT_SECRET'>
  > {}
}
