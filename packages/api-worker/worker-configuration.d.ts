/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --config wrangler.toml --env-interface WorkerBindings --strict-vars=false` (hash: c19bc7788d030264057dc97753c753a0)
