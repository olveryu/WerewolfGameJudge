/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --config wrangler.toml --env-interface WorkerBindings --strict-vars=false` (hash: 09d41215b406ea3b25d83396bc856d79)
// Runtime types generated with workerd@1.20260526.1 2025-04-01 nodejs_compat
interface __BaseEnv_WorkerBindings {
	...
	REQUEST_TRAFFIC: AnalyticsEngineDataset;
	CF_VERSION_METADATA: WorkerVersionMetadata;
	ENVIRONMENT: string;
	FIB_WORD_SUPPLY_ENABLED: string;
	UNDERCOVER_WORD_SUPPLY_ENABLED: string;
	...
	WECHAT_AUTH: DurableObjectNamespace<import("./src/index").WeChatAuthProxy>;
	FIB_WORD_SUPPLY: Workflow<Parameters<import("./src/index").FibWordSupplyWorkflow['run']>[0]['payload']>;
	UNDERCOVER_WORD_SUPPLY: Workflow<Parameters<import("./src/index").UndercoverWordSupplyWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GameRoom" | "WeChatAuthProxy";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "FIB_WORD_SUPPLY_ENABLED" | "UNDERCOVER_WORD_SUPPLY_ENABLED" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_WORKER_SCRIPT_NAME" | "SENTRY_DSN" | "ADMIN_PASSWORD" | "CF_API_TOKEN" | "GEMINI_API_KEY" | "TAVILY_API_KEY" | "GITHUB_REPO_OWNER" | "GITHUB_TOKEN" | "GITHUB_WEBHOOK_SECRET" | "JWT_SECRET" | "RESEND_API_KEY" | "WECHAT_APP_ID" | "WECHAT_APP_SECRET">> {}
}
