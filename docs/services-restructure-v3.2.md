...
| 6     | tests 迁移                 | engine/**tests** → `__tests__/`（含重命名）                                       | 全套门禁            |
...
| `engine/__tests__/actionHandler.test.ts` | `actionHandler.integration.test.ts` | 6     | 避免与 handlers/**tests**/actionHandler.test.ts 冲突 |
...
| ---------------------------- | ------------ | ------------ | ------- |
| Root .ts 文件                | 9            | 9 (#1-9)     | ✅      |
| Root **tests**/              | 4            | 4 (#10-13)   | ✅      |
| core/                        | 3            | 3 (#14-16)   | ✅      |
| night/resolvers/ + **tests** | 17+17=34     | 34 (#17-50)  | ✅      |
| protocol/ + types/           | 5            | 5 (#51-55)   | ✅      |
| engine/store/                | 4            | 4 (#56-59)   | ✅      |
| engine/reducer/              | 4            | 4 (#60-63)   | ✅      |
| engine/handlers/ + **tests** | 6+6=12       | 12 (#64-75)  | ✅      |
| engine/intents/              | 2            | 2 (#76-77)   | ✅      |
| engine/transport/            | 3            | 3 (#78-80)   | ✅      |
| engine/facade/ + **tests**   | 5+3=8        | 8 (#81-88)   | ✅      |
| engine/**tests**/ + boards/  | 4+7=11       | 11 (#89-99)  | ✅      |
