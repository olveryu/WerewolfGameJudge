...
// ---------------------------------------------------------------------------
// Simple host handlers (generated by factory)
// ---------------------------------------------------------------------------

const handleAssign = createSimpleHostHandler(handleAssignRoles, { type: 'ASSIGN_ROLES' as const });
const handleFillBots = createSimpleHostHandler(handleFillWithBots, {
  type: 'FILL_WITH_BOTS' as const,
});
const handleMarkBotsViewed = createSimpleHostHandler(handleMarkAllBotsViewed, {
  type: 'MARK_ALL_BOTS_VIEWED' as const,
});
const handleClearSeats = createSimpleHostHandler(handleClearAllSeats, {
  type: 'CLEAR_ALL_SEATS' as const,
});
const handleRestart = createSimpleHostHandler(handleRestartGame, { type: 'RESTART_GAME' as const });
