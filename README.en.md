...
Earn XP + 2 normal draw tickets every valid game, plus 2 golden tickets on level-up. Daily login also grants 2 free normal tickets. Spend tickets at the capsule machine to collect avatars, avatar frames, seat flairs, and name styles — single or 10-pull, 4 rarity tiers (Common / Rare / Epic / Legendary) with a 10-draw pity guarantee. 1018 collectible items with uncapped levels and advanced titles. Skia physics capsule machine animation + rarity-tiered reveal effects.
