...
const sql = [
  ...
  // Full-unlock user_stats
  `INSERT OR REPLACE INTO user_stats (user_id, xp, level, games_played, unlocked_items, updated_at) VALUES ('${DEV_USER_ID}', ${maxXp}, ${maxLevel}, 100, '${unlockedJson}', datetime('now'));`,
].join(' ');
