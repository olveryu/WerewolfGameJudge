...
BEGIN_TEXT: dict[str, str] = {
    ...
    "seed_wolf": "种狼请睁眼，请确认是否感染狼人袭击的目标。",
    "seed_wolf_infect_reveal": "所有玩家请睁眼，请看手机确认感染信息。",
...
END_TEXT: dict[str, str] = {
    "wolf": "狼人请闭眼。",
    "wolf_queen": "狼美人请闭眼。",
    "dark_wolf_king": "狼王请闭眼。",
    "nightmare": "噩梦之影请闭眼。",
    "gargoyle": "石像鬼请闭眼。",
    "awakened_gargoyle": "觉醒石像鬼，请闭眼。",
    "wolf_robot": "机械狼人请闭眼。",
    "guard": "守卫请闭眼。",
    "witch": "女巫请闭眼。",
    "hunter": "猎人请闭眼。",
    ...
    "poisoner": "毒师请闭眼。",
    "seed_wolf": "种狼请闭眼。",
    "seed_wolf_infect_reveal": "所有玩家请闭眼。",
