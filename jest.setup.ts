...
jest.mock('./src/theme', () => {
  ...
  return {
    ...
    useTokens: () => ({
      ...
      layout: { maxWidth: 600, headerHeight: 56, tabBarHeight: 56, screenPaddingH: 16, screenPaddingV: 24 },
    }),
    spacing: {
      tight: 4, small: 8, medium: 16, large: 24, xlarge: 32, xxlarge: 48,
    },
    typography: {
      caption: 12, secondary: 14, body: 16, subtitle: 18, title: 20,
      heading: 24, hero: 32, display: 40,
      weights: {
        normal: '400', medium: '500', semibold: '600', bold: '700',
      },
    },
    borderRadius: {
      none: 0, small: 8, medium: 12, large: 16, xlarge: 24, full: 9999,
    },
    shadows: {
      none: {},
      sm: {
