...
export default tseslint.config(
  ...
  // =========================================================================
  {
    ignores: [
      ...
      'miniapp/',
      'scripts/',
      // Bundled game-engine output for Edge Functions (generated by build)
      'supabase/functions/_shared/game-engine/',
    ],
  },
  ...
  // =========================================================================
  {
    files: ['src/services/infra/audio/audioRegistry.ts', 'src/utils/avatar.ts', 'src/utils/avatarImages.ts', 'src/utils/avatarImages.web.ts'],
    rules: {
      '@typescript-eslint/no-require-imports': 'off',
    },
  },
