...
import { getAllRoleIds, type RoleId } from '@werewolf/game-engine/werewolf/models/roles';
...
describe('buildRolePlayGuidePrompt', () => {
  ...
  it('returns a non-empty string for a valid role', () => {
    const result = buildRolePlayGuidePrompt('seer');
