...
import { buildNightPlan, type RoleId } from '@werewolf/game-engine/werewolf/models/roles';
import {
  type ActionSchema,
  getSchema,
  type SchemaId,
 ...
 */
export function useWerewolfNightDerived(gameState: LocalWerewolfState | null): NightDerivedValues {
