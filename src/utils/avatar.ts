...
const AVATAR_IMAGES: number[] = [
  ...
  require('../../assets/avatars/raw/maskedMan.png'),
...
/** All local avatar image sources (2048px raw), in stable sorted order. */
export { AVATAR_IMAGES };

/**
 * 512px thumbnail versions — reuse the badge PNGs generated by process_avatars.py.
 * For grids / preview strips where full-res raw images are overkill.
 * Keep in same order as AVATAR_KEYS.
 */
// prettier-ignore
const AVATAR_THUMBS: number[] = [
  require('../../assets/badges/png/512/role_avenger.png'),
  ...
  require('../../assets/badges/png/512/role_dreamcatcher.png'),
  require('../../assets/badges/png/512/role_drunkSeer.png'),
  require('../../assets/badges/png/512/role_gargoyle.png'),
  require('../../assets/badges/png/512/role_graveyardKeeper.png'),
  require('../../assets/badges/png/512/role_guard.png'),
  require('../../assets/badges/png/512/role_hunter.png'),
  require('../../assets/badges/png/512/role_idiot.png'),
  require('../../assets/badges/png/512/role_knight.png'),
  require('../../assets/badges/png/512/role_magician.png'),
  require('../../assets/badges/png/512/role_maskedMan.png'),
  require('../../assets/badges/png/512/role_masquerade.png'),
  require('../../assets/badges/png/512/role_mirrorSeer.png'),
  require('../../assets/badges/png/512/role_nightmare.png'),
  require('../../assets/badges/png/512/role_piper.png'),
  require('../../assets/badges/png/512/role_poisoner.png'),
  require('../../assets/badges/png/512/role_psychic.png'),
  require('../../assets/badges/png/512/role_pureWhite.png'),
  require('../../assets/badges/png/512/role_seer.png'),
  require('../../assets/badges/png/512/role_shadow.png'),
  require('../../assets/badges/png/512/role_silenceElder.png'),
  require('../../assets/badges/png/512/role_slacker.png'),
  require('../../assets/badges/png/512/role_spiritKnight.png'),
  require('../../assets/badges/png/512/role_thief.png'),
  require('../../assets/badges/png/512/role_treasureMaster.png'),
  require('../../assets/badges/png/512/role_villager.png'),
  require('../../assets/badges/png/512/role_votebanElder.png'),
  require('../../assets/badges/png/512/role_warden.png'),
  require('../../assets/badges/png/512/role_wildChild.png'),
  require('../../assets/badges/png/512/role_witch.png'),
  require('../../assets/badges/png/512/role_witcher.png'),
  require('../../assets/badges/png/512/role_wolf.png'),
  require('../../assets/badges/png/512/role_wolfKing.png'),
  require('../../assets/badges/png/512/role_wolfQueen.png'),
  require('../../assets/badges/png/512/role_wolfRobot.png'),
  require('../../assets/badges/png/512/role_wolfWitch.png'),
];
