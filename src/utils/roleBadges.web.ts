/**
 * roleBadges — Role badge asset index (web: WebP)
 *
 * Web uses 128px WebP badge, corresponding to the 512px PNG on native.
 * Metro selects .web.ts automatically per platform.
 * WebP assets generated by scripts/process_avatars.py.
 */
...
/** Get role badge WebP asset (128px) for `<Image source={...} />` */
