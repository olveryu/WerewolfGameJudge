...
import {
  ...
  RoleRevealAnimator,
  ScratchReveal,
} from '@/games/werewolf/components/RoleRevealEffects/index';
import { RoleHunt } from '@/games/werewolf/components/RoleRevealEffects/RoleHunt/RoleHunt';
import type { RoleData } from '@/games/werewolf/components/RoleRevealEffects/types';
