 ...
 *
 * Features: metallic silver scratch layer + diamond pattern + serial number + rules text,
 * scratch texture, metal fragment particles, progress milestone flashes, haptic feedback,
 * "PRIZE" stamp, confetti burst.
...
import { AlignmentRevealOverlay } from '@/games/werewolf/components/RoleRevealEffects/common/AlignmentRevealOverlay';
import { AtmosphericBackground } from '@/games/werewolf/components/RoleRevealEffects/common/effects/AtmosphericBackground';
import { RevealBurst } from '@/games/werewolf/components/RoleRevealEffects/common/effects/RevealBurst';
import { HintWithWarning } from '@/games/werewolf/components/RoleRevealEffects/common/HintWithWarning';
import { RoleCardContent } from '@/games/werewolf/components/RoleRevealEffects/common/RoleCardContent';
import { CONFIG } from '@/games/werewolf/components/RoleRevealEffects/config';
import {
  useAutoTimeout,
  useRevealLifecycle,
} from '@/games/werewolf/components/RoleRevealEffects/hooks/useRevealLifecycle';
import type { RoleRevealEffectProps } from '@/games/werewolf/components/RoleRevealEffects/types';
import { createAlignmentThemes } from '@/games/werewolf/components/RoleRevealEffects/types';
