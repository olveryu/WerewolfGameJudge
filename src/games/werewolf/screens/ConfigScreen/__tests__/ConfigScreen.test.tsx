...
describe('ConfigScreen', () => {
  ...
  describe('Rendering', () => {
    it('should render preset template buttons', () => {
      const { getByText } = renderWithFacade(<ConfigScreen client={createMockFacade()} />);
    ...
    it('should render role selection sections', () => {
      const { getByText, getByTestId } = renderWithFacade(
        <ConfigScreen client={createMockFacade()} />,
      );
  ...
  describe('Navigation', () => {
    it('should render back button', () => {
      const { getByTestId } = renderWithFacade(<ConfigScreen client={createMockFacade()} />);
