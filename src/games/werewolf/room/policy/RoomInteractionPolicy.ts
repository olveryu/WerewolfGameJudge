/**
 * RoomInteractionPolicy.ts - Unified pure function strategy for all WerewolfRoomScreen interactions
 *
...
function handleSeatTap(
  ...
  switch (seatResult.kind) {
    ...
    case 'VIEW_PROFILE':
      return { kind: 'VIEW_PROFILE', seat: seatResult.seat, targetUserId: seatResult.targetUserId };
  }
}
