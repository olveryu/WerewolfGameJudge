 ...
 * All user interactions in WerewolfRoomScreen go through these types.
 *
...
import type { RevealKind, RoleId } from '@game-judge/game-engine/games/werewolf/public';
...
export type ActionIntentType =
  // Reveal (ANTI-CHEAT: WerewolfRoomScreen only waits for private reveal + sends ack)
  | 'reveal'
...
export interface ActionIntent {
   ...
   * (e.g., 'save' or 'poison' for witch). Used by WerewolfRoomScreen to derive confirm copy + payload.
   */
  stepKey?: string;
 ...
 * This is a subset of WerewolfRoomScreen state - only what the policy needs.
 */
