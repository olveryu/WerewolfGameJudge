...
// =============================================================================
// toGameRoomLike — canonical local projection
// =============================================================================

describe('toGameRoomLike — canonical local projection', () => {
  it('uses the required local wolfVotes map', () => {
    const wolfVotes = new Map([[0, 1]]);
  ...
  it('preserves an empty required wolfVotes map', () => {
    const state: LocalGameState = {
      ...WEREWOLF_STATE_IDENTITY,
      roomCode: 'TEST',
      hostUserId: 'host1',
