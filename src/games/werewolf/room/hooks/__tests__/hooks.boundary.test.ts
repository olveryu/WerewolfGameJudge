/**
 * Boundary tests for WerewolfRoomScreen hooks
 *
...
describe('WerewolfRoomScreen hooks boundary constraints', () => {
  const hookFiles = [
    'useActionerState.ts',
    'useActionOrchestrator.ts',
    'useInteractionDispatcher.ts',
    'useRoomActions.ts',
    'useWerewolfRoomScreenState.ts',
  ];
