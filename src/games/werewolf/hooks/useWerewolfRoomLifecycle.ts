/**
 * useWerewolfRoomLifecycle - Room creation, joining, leaving, and seat management
 *
...
interface WerewolfRoomLifecycleState {
  loading: boolean;
  error: string | null;
...
interface WerewolfRoomLifecycleDeps {
  facade: IGameFacade;
 ...
 */ export function useWerewolfRoomLifecycle(
  deps: WerewolfRoomLifecycleDeps,
): WerewolfRoomLifecycleState {
