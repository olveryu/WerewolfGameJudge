/**
 * useWerewolfAckMutation — TanStack Query mutation wrapper for server-ack roundtrips.
 *
 ...
 *
 * Zero retries; unified mutationKey so useWerewolfPendingAcks can aggregate status.
 *
 ...
 */
export function useWerewolfAckMutation<TArgs, TData>(
  name: AckName,
