...
const TEMPLATE_TO_TEST_PATTERN: Record<string, RegExp> = {
  ...
  石像守墓: /TEMPLATE_NAME\s*=\s*['"]石像守墓['"]/,
  梦魇守卫: /TEMPLATE_NAME\s*=\s*['"]梦魇守卫['"]/,
  血月猎魔: /TEMPLATE_NAME\s*=\s*['"]血月猎魔['"]/,
  狼王摄梦: /TEMPLATE_NAME\s*=\s*['"]狼王摄梦['"]/,
  狼王魔术: /TEMPLATE_NAME\s*=\s*['"]狼王魔术['"]/,
  机械通灵: /TEMPLATE_NAME\s*=\s*['"]机械通灵['"]/,
  恶灵骑士: /TEMPLATE_NAME\s*=\s*['"]恶灵骑士['"]/,
  纯白夜影: /TEMPLATE_NAME\s*=\s*['"]纯白夜影['"]/,
  灯影预言: /TEMPLATE_NAME\s*=\s*['"]灯影预言['"]/,
};
