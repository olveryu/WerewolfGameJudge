...
import { defineRoomAction, type RoomActionContext } from '@/services/room/defineRoomAction';
import type { IRoomService } from '@/services/types/IRoomService';
import { facadeLog } from '@/utils/logger';

import type { FibActionResult, IFibFacade } from './IFibFacade';
...
export class FibFacade implements IFibFacade {
