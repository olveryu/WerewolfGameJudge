 ...
 * - actionPrompt: seer, witch, hunter, wildChild actions
 ...
 *
 * Note: wildChild has chooseSeat (canSkip=false), contributes actionConfirm (already from seer).
 *
