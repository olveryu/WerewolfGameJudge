 ...
 *
 * Note: dancer/masquerade have no night-1 action, so no extra dialog types.
 * This board has NO hunter/guard, so no confirmTrigger/skipConfirm required from them.
 */
