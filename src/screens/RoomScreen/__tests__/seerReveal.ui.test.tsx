...
// Room state: ongoing, seer is actioner. Seat taps should drive seerReveal intent.
...
// Force seat taps -> seerReveal intent
...
describe('RoomScreen seer reveal UI (smoke)', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
